...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        past=None,
        head_mask=None,
        latent_as_gpt_emb=False,  # add ###############
        latent_as_gpt_attn=False,  # add ###############
    ):
        # add ###############
        if latent is None:
        ...
        all_attentions = []
        all_hidden_states = ()
        for i, (block, layer_latent, layer_past) in enumerate(
            zip(self.h, latent, past)
        ):  # change ##########
            ...
            outputs = block(
                hidden_states, layer_latent, layer_past, head_mask[i]
            )  # change ##########
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        transformer_outputs = self.transformer(
            ...
            past=past,
            head_mask=head_mask,
            latent_as_gpt_emb=self.latent_as_gpt_emb,  # add ###############
            latent_as_gpt_attn=self.latent_as_gpt_attn,  # add ###############
        )
